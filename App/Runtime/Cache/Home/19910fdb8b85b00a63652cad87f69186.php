  ...
  <body>
        ...
        <div class="container">
            <ol class="breadcrumb">
              ...
              <?php if(is_array($frontNav["sait"])): foreach($frontNav["sait"] as $key=>$value): ?><li><a href="<?php echo U('List/index',array('id'=>$value['id']));?>"><?php echo ($value["name"]); ?></a></li><?php endforeach; endif; ?>
            </ol>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <?php if(is_array($listNewsTitle)): foreach($listNewsTitle as $key=>$value): ?><div class="media list_news">
                ...
                <div class="col-md-4">
                    <div class="panel panel-default">
                      ...
                      <div class="panel-body">
                          <?php if(is_array($frontNav["child"])): foreach($frontNav["child"] as $key=>$value): ?><a href="<?php echo U('List/index',array('id'=>$value['id']));?>" class="btn btn-primary"><?php echo ($value["name"]); ?></a><?php endforeach; endif; ?>
                      </div>
                    </div>
