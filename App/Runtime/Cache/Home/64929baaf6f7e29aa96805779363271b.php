        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 acticle">
                      ...
                      <div class="d4">
                        TAG标签：
                        <?php if(is_array($oneChapter['tag'])): foreach($oneChapter['tag'] as $key=>$value): ?><a class="btn btn-success tag"  href="<?php echo U('Chapter/searchTag',array('tag'=>$value));?>" target="_blank" ><?php echo ($value); ?></a><?php endforeach; endif; ?>
                      </div>
                      <div class="d5">
